          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="terms" style={{ borderColor: "#9F68F0" }} />
                <label
                  htmlFor="terms"
                ...
                >
                  I agree to the{" "}
                  <Link to="/terms" style={{ color: "#9F68F0" }} className="hover:underline underline-offset-4">
                    Terms of Service
                  </Link>
                  {" "}and{" "}
                  <Link to="/privacy" style={{ color: "#9F68F0" }} className="hover:underline underline-offset-4">
                    Privacy Policy
                  </Link>
                </label>
              </div>
